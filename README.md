...
e-commerce data processing using Apache Spark Structured Streaming, Neo4j, Docker, and Python. The system processes streaming purchase events, performs ETL, analyzes customer behavior, detects trending products, and generates personalized product recommendations.
